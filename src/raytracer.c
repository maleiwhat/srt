...
void draw_raytracer() {
	...
	*/
	...
	srtLightAmbient4(0.15f, 0.15f, 0.15f, 0.15f);
	srtLightDiffuse4(0.45, 0.45, 0.45, 0.45);
	srtLightSpecular4(0.25, 0.25, 0.25, 0.85);
	srtLightPosition3(0.0, 0.75, 2.2);
	...
	srtMatReflectivity(0.73);
	srtMatShininess(2.3);
	
	srtVector3 bc = {-0.25, -0.65, -9.15};
	srtVector3 br = {0.85, 0.85, 0.85};
	srtMatrix44 bxform;
	srtMat44_RotationY(bxform, 0.0);
